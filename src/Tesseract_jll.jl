...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Tesseract_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("efd95c89-babc-5260-8753-618084eaf9d7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Tesseract", artifacts_toml) for e in artifacts["Tesseract"]]
...
if best_platform === nothing
    @debug("Unable to load Tesseract; unsupported platform $(triplet(platform_key_abi()))")
else
