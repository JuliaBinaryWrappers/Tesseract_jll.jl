# Autogenerated wrapper script for Tesseract_jll for x86_64-apple-darwin14-cxx11
...
const libtesseract_splitpath = ["lib", "libtesseract.4.dylib"]
...
const libtesseract = "@rpath/libtesseract.4.dylib"
